...
def run_sft(cfg: Any) -> None:
    ...
    sft_args = SFTConfig(
        ...
        save_total_limit=_optional_positive_int(cfg.train.get("save_total_limit")),
...
def _write_dataset_info(
    ...
    payload = {
        ...
        "validation_file": _optional_str(cfg.data.get("validation_file")),
        "attack_file": _optional_str(cfg.data.get("attack_file")),
